...
module.exports = async function (deployer) {
    ...
    await deployer.deploy(PythImplementation, buildDeployerProps(deployer));
    // deploy implementation
    await deployer.deploy(PythSetup, buildDeployerProps(deployer));
    ...
    // deploy proxy
    await deployer.deploy(PythDataBridge, PythSetup.address, initData, buildDeployerProps(deployer));
};
